...
|   STMeta-Raw-Concat    |   V1    | **3.37618** | 144.60 hour / 5362 epochs  |
|     STMeta-Raw-Add     |   V1    |   3.40535   | 223.17 hour / 9094 epochs  |
|   STMeta-Raw-Gating    |   V1    | **3.37795** | 120.89 hour / 4043 epochs  |
|   STMeta-Emb-Concat    |   V1    |   3.47122   | 204.53 hour / 7992 epochs  |
|     STMeta-Emb-Add     |   V1    |   3.41328   | 244.73 hour / 10000 epochs |
|   STMeta-Emb-Gating    |   V1    |   3.41039   | 134.83 hour / 5460 epochs  |
| STMeta-MultiEmb-Concat |   V1    |   3.38418   | 153.24 hour / 4638 epochs  |
|  STMeta-MultiEmb-Add   |   V1    |   3.45203   | 164.15 hour / 6655 epochs  |
...
|   STMeta-EarlyConcat   |   V1    |             |                            |
|    STMeta-EarlyAdd     |   V1    |             |                            |

| **City: Chicago** | Version |  test-rmse  |      Converged Time       |
| :---------------: | :-----: | :---------: | :-----------------------: |
|      STMeta       |   V1    |   2.73998   | 22.00 hour / 1430 epochs  |
|   STMeta-Raw-Concat   |   V1    |   2.66504   | 165.83 hour / 9360 epochs |
| STMeta-Emb-Concat |   V1    |   2.62967   |  12.22 hour / 718 epochs  |
| STMeta-MultiEmb-Concat |   V1    | **2.59255** |  13.46 hour / 783 epochs  |
|    STMeta-Raw-Add |   V1    |   2.63242   | 103.44 hour / 6511 epochs |
|    STMeta-LSTM-Add    |   V1    | **2.58002** | 53.36 hour / 3226 epochs  |
|   STMeta-Raw-Gating   |   V1    |   2.59783   | 67.95 hour / 3888 epochs  |
|     STMeta-Emb-Add     |   V1    | 2.70074 | 146.93 hour / 9534 epochs |
|   STMeta-Emb-Gating    |   V1    | 2.60807 | 36.35 hour / 2227 epochs |
|  STMeta-MultiEmb-Add   |   V1    | 2.63420 | 136.58 hour / 8885 epochs |
...
|  STMeta-MultiEmb-Add   |   V1    |       | 2.42924 | 49.12 hour / 3785 epochs |
...
|   STMeta-EarlyConcat   | V1 | 896482 | 2.74993 | 12.99 hour / 763 epochs |
|    STMeta-EarlyAdd     | V1 | 489214 | 2.58238 | 39.68 hour / 2333 epochs |
...
|  STMeta-MultiEmb-Add   |   V1    |       | 11.77740 | 6.06112 |8.21 hour / 9008 epochs|
...
|   STMeta-EarlyConcat   | V1 | 924130 | 9.88542 | 11.71063 |2.25 hour / 1620 epochs|
|    STMeta-EarlyAdd     | V1 | 489250 | 7.97958 | 6.71774 |3.14 hour / 2489 epochs|

| **City: Chengdu** | Version | val-rmse | test-rmse |     Converged Time      |
| :---------------: | :-----: | :------: | :-------: | :---------------------: |
|      STMeta       |   V1    | 6.81043  |  6.90155  | 1.58 hour / 1218 epochs |
|   STMeta-Raw-Concat   |   V1    | 7.07804  |  7.51672  | 5.75 hour / 5944 epochs |
| STMeta-Emb-Concat |   V1    | 6.86758  |  7.01818  | 2.00 hour / 1388 epochs |
| STMeta-MultiEmb-Concat |   V1    | 7.21825  |  7.36653  | 4.63 hour / 4033 epochs |
|    STMeta-Raw-Add |   V1    | 6.77974  |  6.98959  | 1.53 hour / 767 epochs  |
|  STMeta-LSTM-Add  |   V1    | 6.89801  |  7.00606  | 1.87 hour / 1187 epochs |
|   STMeta-Raw-Gating   |   V1    | 6.84756  |  6.95486  | 1.49 hour / 1300 epochs |
|     STMeta-Emb-Add     |   V1    | 6.99524 | 7.038321 |1.84 hour / 1581 epochs|
...
|  STMeta-MultiEmb-Add   |   V1    |       | 116.85288 | 175.7444 |6.54 hour / 4384 epochs|
...
|   STMeta-EarlyConcat   | V1 | 924130 | 574.3068 | 1159.061 |5.98 hour / 4685 epochs|
|    STMeta-EarlyAdd     | V1 | 489250 | 184.53412 | 301.2151 |5.05 hour / 3956 epochs|

| **City: Chongqing** | Version | val-rmse  |  test-rmse   |      Converged Time       |
| :-----------------: | :-----: | :-------: | :----------: | :-----------------------: |
|       STMeta        |   V1    | 96.49490  |   92.83833   | 108.53 hour / 9808 epochs |
|    STMeta-Raw-Concat    |   V1    | 90.67642  |   90.54800   | 38.79 hour / 10000 epochs |
|  STMeta-Emb-Concat  |   V1    | 92.78490  | **84.36934** | 74.88 hour / 6481 epochs  |
| STMeta-MultiEmb-Concat |   V1    | 88.46373  | **86.56753** | 129.20 hour / 9958 epochs |
|     STMeta-Raw-Add  |         | 92.31516  |   90.19092   | 61.63 hour / 10000 epochs |
|   STMeta-LSTM-Add   |   V1    | 101.02728 |   93.65583   | 29.31 hour / 4357 epochs  |
|    STMeta-Raw-Gating    |   V1    | 94.25858  |   87.03069   | 39.27 hour / 10000 epochs |
...
|  STMeta-MultiEmb-Add   |   V1    | 87.24216 | 91.13690 |53.33 hour / 10000 epochs|
...
|   **City: Shanghai**   | embedding size | val-rmse  | test-rmse |     Converged Time      |
| :--------------------: | :------------: | :-------: | :-------: | :---------------------: |
| STMeta-MultiEmb-Concat |       4        | 114.76000 | 171.56076 | 1.94 hour / 280 epochs  |
| STMeta-MultiEmb-Concat |       6        | 113.25427 | 156.60223 | 10.11 hour / 927 epochs |
| STMeta-MultiEmb-Concat |       8        | 115.36623 | 180.37663 | 1.21 hour / 534 epochs  |
| STMeta-MultiEmb-Concat |       10       | 112.31456 | 177.23885 | 1.43 hour / 620 epochs  |

**Different weather embedding size**（default batch_size: 8 tp_emb:6）

|   **City: Shanghai**   | embedding size | val-rmse  | test-rmse |     Converged Time     |
| :--------------------: | :------------: | :-------: | :-------: | :--------------------: |
| STMeta-MultiEmb-Concat |       4        | 109.41055 | 171.02711 | 0.80 hour / 348 epochs |
| STMeta-MultiEmb-Concat |       6        | 123.74634 | 166.39934 | 1.34 hour / 683 epochs |
| STMeta-MultiEmb-Concat |       8        | 123.71514 | 182.98827 | 0.93 hour / 418 epochs |
| STMeta-MultiEmb-Concat |       10       | 121.60524 | 179.59850 | 0.85 hour / 398 epochs |
| STMeta-MultiEmb-Concat |       12       | 115.26234 | 171.73476 | 1.35 hour / 718 epochs |

**Different batch effect **

|   **City: Shanghai**   | batch | val-rmse  | test-rmse |     Converged Time      |
| :--------------------: | :---: | :-------: | :-------: | :---------------------: |
| STMeta-MultiEmb-Concat |  16   | 113.86533 | 181.91652 | 1.39 hour / 498 epochs  |
| STMeta-MultiEmb-Concat |   8   | 123.13991 | 181.91342 | 4.90 hour / 2032 epochs |
| STMeta-MultiEmb-Concat |   4   | 122.49625 | 179.65306 | 1.01 hour / 242 epochs  |
| STMeta-MultiEmb-Concat |   2   | 112.73404 | 178.33081 | 1.67 hour / 290 epochs  |
...
|  STMeta-MultiEmb-Add   |   V1    |       | 0.75049 | **0.77776** |16.55 hour / 9986 epochs|
...
|   STMeta-EarlyConcat   | V1 | 601570 | 1.23185 | 1.49814 |2.30 hour / 1102 epochs|
|    STMeta-EarlyAdd     | V1 | 330058 | 0.74285 | 0.79755 |19.93 hour / 10000 epochs|
...
| :---------------: | :-------------: | :------: | :-------: | :----------------------: |
| STMeta-Raw-Gating |        7        | 1.74639  |  5.73942  |  0.05 hour / 433 epochs  |
| STMeta-Raw-Gating |       28        | 3.01493  |  2.82653  | 0.72 hour / 1468 epochs  |
| STMeta-Raw-Gating |       49        | 2.50811  |  2.66609  |  0.84 hour / 626 epochs  |
| STMeta-Raw-Gating |       70        | 2.40444  |  2.55819  |  1.36 hour / 517 epochs  |
| STMeta-Raw-Gating |       91        | 2.32534  |  2.53470  | 3.72 hour / 1097 epochs  |
| STMeta-Raw-Gating |       112       | 2.47813  |  2.52416  | 4.99 hour / 1128 epochs  |
| STMeta-Raw-Gating |       133       | 2.42334  |  2.52744  | 10.45 hour / 1968 epochs |
| STMeta-Raw-Gating |       154       | 2.39524  |  2.53610  | 6.91 hour / 1048 epochs  |
| STMeta-Raw-Gating |       196       | 2.42895  |  2.51162  | 7.34 hour / 1126 epochs  |
| STMeta-Raw-Gating |       259       | 2.50016  |  2.52670  | 12.70 hour / 1456 epochs |
| STMeta-Raw-Gating |       322       | 2.47781  |  2.48798  | 24.38 hour / 2259 epochs |
| STMeta-Raw-Gating |       385       | 2.43614  |  2.44860  | 26.27 hour / 2226 epochs |
...
| STMeta-Raw-Gating |      -      | 6.62653  |   5.80114   |  1.57 hour / 410 epochs   |
...
| STMeta-Raw-Gating |      -      | 0.74789  |   0.78317   | 9.68 hour / 4563 epochs  |
